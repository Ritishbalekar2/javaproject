...
class Menu1 {
    private final ArrayList<String> scoopFlavors = new ArrayList<>();
    private final ArrayList<Integer> scoopPrices = new ArrayList<>();
    private final ArrayList<String> coneFlavors = new ArrayList<>();
    private final ArrayList<Integer> conePrices = new ArrayList<>();
    private final ArrayList<String> tubFlavors = new ArrayList<>();
    private final ArrayList<Integer> tubPrices = new ArrayList<>();
    private final ArrayList<String> barFlavors = new ArrayList<>();
    private final ArrayList<Integer> barPrices = new ArrayList<>();
    ...
    private void initializeFlavorsAndPrices() {
        // Initialize scoop flavors and prices
        ...
        // Initialize cone flavors and prices
        ...
        // Initialize tub flavors and prices
        ...
        // Initialize bar flavors and prices
    ...
    private void handleOrder(ArrayList<String> flavors, ArrayList<Integer> prices) {
    ...
    // Manager methods for managing flavors and prices
